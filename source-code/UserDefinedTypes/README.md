...
Code illustrations for chapter 2, User defined types in Stroustrup's "A tour of
C++".


# What is it?

1. `struct_particles.cpp`: implementation of particles as struct data type.
...
1. `stats.h`: `Stats` class definition that keeps statistics for steraming data
