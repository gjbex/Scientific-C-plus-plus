...
1. `particle.h`: declaration of the `Particle` class in the namespace
   `particle`.
...
1. `particles_main_no_using.cpp`: main function for the particles application,
   with namespace prefixes instead of `using` directives.
