...
When you complete this training you will be able to
  ...
  * know how to use third-party libraries such as Armadillo or Eigen for
    linear algebra;
  * have a solid foundation for follow-up work in scientific and high-performance
    C++ programming.
...
language and want to learn modern C++ for scientific applications.
...
You do not need prior experience with C++ itself, templates, inheritance, the
...
These percentages describe the level of the C++ and scientific-computing topics
covered in the training, not the participants' general programming background.
